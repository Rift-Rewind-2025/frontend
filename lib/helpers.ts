...
// FETCH
const baseUrl = process.env.API_BASE_URL || "https://vcjbhrvzwc5byvjkmbkci36ztu0vzlzv.lambda-url.us-east-2.on.aws";

async function fetchJSON<T>(path: string, method: RequestInit['method'] = "GET", headers?: HeadersInit, body?: BodyInit): Promise<T> {
