...
export function RiotIdSearch({
  ...
  return (
    <Card className="w-full max-w-2xl mx-auto bg-[#10161a]/90 border border-[rgba(214,176,93,.18)] shadow-[0_0_0_1px_rgba(214,176,93,.25),0_10px_30px_rgba(0,0,0,.45)]">
      ...
      <CardContent>
        <div className="flex gap-2">
          ...
          <Button
            ...
            className="border border-[rgba(214,176,93,.25)] hover-"
        ...
        <p className="text-xs text-white/70 mt-2">
          We’ll pin this player in the leaderboard and use them in the Gold
          Game.
        </p>
      </CardContent>
    </Card>
